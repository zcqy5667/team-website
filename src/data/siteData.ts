...
export const qaItems: QAItem[] = [
  {
    category: "报名与加入",
    question: "什么时候开始报名？怎么报名加入战队/参加培训？现在还能报名吗？",
    answer: ["加入招新群就算正式报名啦，后续我们会在招新群里面通知培训的相关事项的"]
  },
  {
    category: "报名与加入",
    question: "怎么参加活动？怎么联系相关人员？",
    answer: ["小活动会在军训期间进行举办，直接来我们基地就可以进行参加，需要联系的话直接在群里@或者私聊学长学姐都是可以的"]
  },
  {
    category: "报名与加入",
    question: "大二还能参加吗？",
    answer: ["只要你大二能具备我们需要能力并通过考核就可以参加，但是大二我们并不会再对其进行培训"]
  },
  {
    category: "报名与加入",
    question: "加入之后可以加学分吗？",
    answer: ["可以的，我们参加比赛会加创新创业方向的学分"]
  },
  {
    category: "考核与选拔",
    question: "以后是要经过考核才能正式进入社团吗？",
    answer: ["是的，我们会在每轮培训后进行考核，通过我们的最终考核就可以加入基地了"]
  },
  {
    category: "考核与选拔",
    question: "全部考核一般什么时候结束？什么时候可以明确知道自己是否加入了？",
    answer: ["全部考核会在开学后结束，每轮考核结束我们都会以名单的形式在培训群中进行通知"]
  },
  {
    category: "考核与选拔",
    question: "培训前的面试一般一组招录多少人？",
    answer: ["我们目前是不会有面试环节的，如果后续有其他变更请大家留意招新群或者培训通知"]
  },
  {
    category: "考核与选拔",
    question: "电控开始考核大概是什么内容？",
    answer: ["电控开始考核主要是c语言，具体的可以查看飞书中的培训流程图"]
  },
  {
    category: "考核与选拔",
    question: "如果想进机械组，会考哪方面的知识？",
    answer: ["机械组的考核主要是机械制图和三维建模，具体的可以查看飞书中的培训流程图"]
  },
  {
    category: "考核与选拔",
    question: "算法组有上机环节吗？",
    answer: ["算法组的培训肯定要进行上机操作的"]
  },
  {
    category: "分组与队伍安排",
    question: "考核完后是分多个队伍还是一个大队伍？如果是多队伍，如何安排队友？",
    answer: ["考核完后就是一个大队伍，大家会根据提前选好的兵种以及组别进行对应的分组"]
  },
  {
    category: "分组与队伍安排",
    question: "听说一个大学只能安排一个队伍参加比赛，如何确定最终队伍成员？",
    answer: ["只要加入了我们基地，最后参加比赛的队伍成员就是基地成员，基地成员都是可以参加比赛的"]
  },
  {
    category: "分组与队伍安排",
    question: "分组是自己选择还是战队内分配？",
    answer: ["分组是自己根据兴趣自由选择的"]
  },
  {
    category: "分组与队伍安排",
    question: "现在学习自己选择的组的相关知识，后续分到其他组怎么办？",
    answer: ["我们在最后的分组中都是会根据大家的志愿来进行分组的，不用太担心"]
  },
  {
    category: "培训与学习",
    question: "培训是组织课程还是自学？培训周期大概多久？培训是什么时候？",
    answer: ["各个组会组织一些比较难的课程来进行培训，基础的部分是自学的，培训周期在后续培训群中会详细通知，我们在国庆后会正式开始培训"]
  },
  {
    category: "培训与学习",
    question: "被选入后需要占用很多课后时间吗？进去是直接上手搞科技吗？",
    answer: ["被选入后如果你的任务完成的话是不会占用很多课后时间的，当你通过最终考核后我们会直接手把手教你怎么去做车，调车"]
  },
  {
    category: "培训与学习",
    question: "这个基地水吗？是真材实料吗？",
    answer: ["每一个机器人都是学长学姐通过自己的学习和努力进行调试和制作的，肯定是有真材实料的"]
  },
  {
    category: "培训与学习",
    question: "新人阶段每周大概需要投入多少时间？",
    answer: ["因为每个人能力的不同，推荐大家根据自己的学习情况来安排每周所花的时间，我们会更推荐你多花点时间去学习本组所需的知识（但也别耽误了学业！！！）"]
  },
  {
    category: "培训与学习",
    question: "后面是不是要花很多时间培训，甚至和课程冲撞？",
    answer: ["培训的时间适合课程相撞的，至于组织培训的时间是不会与学校课程相撞的"]
  },
  {
    category: "培训与学习",
    question: "参加这个基地要不要经常熬夜？再参加一个社团是不是有点吃不消？",
    answer: ["如果你的任务能按时完成是不需要熬夜的，学长学姐也有参加多个社团，不会吃不消的，不过具体的还是要根据自身实际情况来安排自己的时间"]
  },
  {
    category: "电脑与设备",
    question: "学习需要电脑吗？目前没有电脑，能学习吗？",
    answer: ["我们一轮的学习是可以不用电脑的，即使你现在还没有电脑也是可以学习的，但是后续的学习安排还是推荐有一台属于自己的电脑"]
  },
  {
    category: "电脑与设备",
    question: "算法组电脑最晚要求什么时候要有？目前还没买。",
    answer: ["算法组的电脑最晚需要在11月一轮考核结束之后买"]
  },
  {
    category: "电脑与设备",
  ...
  {
    category: "电脑与设备",
    question: "硬件组最晚什么时候用电脑？目前没有买。",
    answer: ["硬件组的电脑最晚需要在 11 月一轮考核结束之后买"]
  },
  {
    category: "电脑与设备",
    question: "电脑需要什么配置才能在算法组四年下来不用换机？游戏本吗？",
    answer: ["是的，我们更推荐你有一台游戏本，如果你不会具体的保养电脑，学长学姐也会教你的，配置的话推荐私聊学长学姐具体了解噢"]
  },
  {
    category: "电脑与设备",
    question: "电脑需要什么类型，有什么推荐的？办公本还是游戏本？要5060还是4060？本人不玩游戏。",
    answer: ["电脑更推荐游戏本，显卡没有太大需求（尽量不要买神秘的华为荣耀苹果本）"]
  },
  {
    category: "活动、比赛与团队情况",
    question: "线下小活动是什么时候？",
  ...
  {
    category: "活动、比赛与团队情况",
    question: "活动中我们做什么？如何确定自己的定位？",
    answer: ["日常活动就是完成基地所布置的任务，定位则是根据你所在的兵种和组别来确定"]
  },
  {
    category: "活动、比赛与团队情况",
    question: "打比赛一般是什么时候进行？",
    answer: ["比赛会在每年的4月、5月进行"]
  },
  {
    category: "活动、比赛与团队情况",
    question: "目前团队有什么成果？",
    answer: ["目前基地获得国赛的一等奖，二等奖、三等奖等，具体的可以查看官网的成果一栏"]
  },
  {
    category: "活动、比赛与团队情况",
    question: "战队目前有多少人？",
  ...
  {
    category: "专业与方向",
    question: "我是网络工程专业，学习电控如何（针对专业来说）？",
...
export const team: Team = {
  ...
  summary:
    "我们是一支面向 RoboMaster 机甲大师赛事的学生工程战队，围绕机械、电控、硬件、算法、运营等方向持续研发与协作。",
  detail:
...
export const units: Unit[] = [
  ...
  },
  {
    ...
    responsibilities: ["能量单元装配和金币获取", "保障队伍补给与经济循环", "执行场地机关交互任务", "为火力单位创造持续作战条件"],
